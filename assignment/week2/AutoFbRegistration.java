...
//Facebook Registration Automation using Selenium WebDriver
...
public class AutoFbRegistration {
    public static void main(String[] args) {
        ...
        // to find all the elements and perform actions in the facebook registration
        // form
        ...
        yeardropdownOptions.selectByVisibleText("year");
